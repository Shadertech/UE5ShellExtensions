...
try {
    ...
    Write-Output "--cooking for WindowsClient"
    Start-Process -FilePath $editorCmdPath -ArgumentList "$projectPath", "-run=Cook", "-TargetPlatform=WindowsClient", "-unattended", "-log"
